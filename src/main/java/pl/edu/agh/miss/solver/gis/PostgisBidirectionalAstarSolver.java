 ...
 */
public class PostgisBidirectionalAstarSolver implements ISolver {

    @Override
    public Path findPath(Node startNode, Node endNode) {
        return JavaGisDao.getRouteWithBidirectionalAstarAlgorithm(startNode.getOsmId(), endNode.getOsmId());
    }
