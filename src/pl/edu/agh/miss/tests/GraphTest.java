...
public class GraphTest implements IGraphTest {
    ...
    public Graph createTestGraph() {
        ...
        Graph testGraph = new Graph("Redville Simple Test");
        testGraph.addVertex(redville);
        testGraph.addVertex(blueville);
        testGraph.addVertex(greenville);
        testGraph.addVertex(orangeville);
        testGraph.addVertex(purpleville);
        return testGraph;
    }
